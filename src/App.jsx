    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-6 text-slate-900">
      <div className="max-w-md rounded-2xl border border-slate-200 bg-white p-6">
        ...
        <p className="mt-2 text-sm text-slate-600">
          This app needs your Supabase keys. Create a <code className="rounded bg-slate-100 px-1">.env</code> file
...
VITE_SUPABASE_ANON_KEY=your-anon-key`}
        ...
        <p className="mt-3 text-sm text-slate-600">
          Find both under <span className="font-semibold">Supabase → Project Settings → API</span>. See the README for
